# декоратор
# пропишем логику декоратора используя регулярки для распознавания имен контактов и номера  телефона , пропишем исключения для команд
# в которых на индексе 1 будет стоять не имя контакта (show all , good bye )
import re
